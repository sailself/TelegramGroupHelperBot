...
- `call_gemini(...)`: Core text/vision entry point that supports search grounding, optional URL Context, a configurable thinking level, inline media, and output-language hints.
